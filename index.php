  ...
  <body>
    ...
    <div class="capa">
      ...
      <div class="formulario">
        <div class="container">
          <form id="login" name="login" method="post" action="valida2.php" >
            <p class="format-p" >Nucleo de Inteligência SIM</p>
            ...
            <button type="submit" class="btn btn-primary btn-block " name="logar" value="Acessar" onclick="validaLogin()">Logar</button>
          </form>
        </div>
      </div>
    </div>
